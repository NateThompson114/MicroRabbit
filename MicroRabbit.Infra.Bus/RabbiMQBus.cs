...
{
    public sealed class RabbiMQBus : IEventBus
    {
        ...
        public RabbiMQBus(IMediator mediator, IServiceScopeFactory serviceScopeFactory)
        {
            _mediator = mediator;
        ...
        {
            // 1st TransferToDbBus subscribes
            ...
            if (_handlers[eventName].Any(handler => handler.GetType() == handlerType))
            {
